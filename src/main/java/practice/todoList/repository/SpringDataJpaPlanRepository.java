...
public interface SpringDataJpaPlanRepository extends JpaRepository<Plan, Integer>, PlanRepository {
    @Override
    List<Plan> findByUserIdAndDate(String userId, LocalDate date);
